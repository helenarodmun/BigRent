                                ...
                                <tr>
                                    ...
                                    <td>
                                        <TipInfo content="Modificar contrato" direction="left">
                                            <Link method="get" href={"/editarContrato/" + contrato.id} as="button" className="h5 border-0 bi bi-pencil-square text-primary m-2"/>
                                        </TipInfo>
                                        ...
                                        <TipInfo content="Cerrar contrato" direction="left">
                                            <Link href={"/modificaContrato" + contrato.id}   as="button" className="h5 border-0 bi bi-x-octagon-fill text-danger m-2"/>
                                        </TipInfo>                                      
                                          <ModalConfirmacion show={showConfirmModal}
                                            ...
                                            urlAccion="/cerrarContrato" idRegistro={idToUpdate}/>
                                    </td>
                                </tr>
                            </tbody>))}
                    </Table>
