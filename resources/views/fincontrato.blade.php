...
<head>
    ...
    <title>Finalización de contrato</title>
	
	
<?php
$negro	 		= "#000";	
$naranja 		= "#F3B465";	
$naranja_claro	= "#D9D9D9";	

$azul	 		= "#3A5185";	
$azul_claro		= "#D9D9D9";	
$azul_claro_firma="#D9D9D9";	

$rojo			= "#E74A53";	
$rojo_claro		= "#D9D9D9";	
$rojo_claro_firma="#D9D9D9";	
...
<style>
	...
	.div_dias_precio > .titulo {
		background: #DCF2C2;
		padding: 5;
		border: 2px solid #000;
		
	}
	.div_dias_precio > .valor {
		font-size: 1.5rem;	
		border: 2px solid #000;
		border-top: 0px;
...
$fecha_contrato = e($contrato->fecha_entrega);
...
?>	
	...
	<!------- Datos maquina ------->
			...
			<div class="linea_datos">
				<div class="valor display_inline" style="width: 688px; min-height: 80px; max-height: 120px; background-color: <?= $naranja_claro ?>;">
					<?= e($contrato->notas2) ?> &nbsp; 
				</div>
			</div>
<div class="linea_separacion"></div>
			...
			<div class="linea_datos" style="padding-bottom: 0px;">
				<div class="titulo display_inline">INCIDENCIA:</div>
			</div>
			<div class="linea_datos">
				<div class="valor display_inline" style="width: 688px; min-height: 80px; max-height: 120px; background-color: <?= $verde ?>;  color: #fff;">
					<?= e($contrato->notas1) ?> &nbsp; 
				</div>
			</div>
...
<div class="div_firmas ">
	<div class="d_50 display_inline" align="left">
		<div class="div_firma">
			...
			<div align="left" class="datos_firma" style="background: <?= $negro ?>">
	...
	<div class="d_50 display_inline " align="right" style="float: right">
		<div class="div_firma">
			...
			<div align="left" class="datos_firma" style="background: <?= $negro ?>">
				<div class="display_inline" align="left"><?= ucfirst($usuario->username) ?></div>
...
<div class="cuadro_final">
	...
	<div class="total display_inline" style="float: right; vertical-align: top;">
		<?php
			$precio_alquiler = number_format(e($contrato->importe_total), 2); //number_format(e($subfamilia->fianza), 2)
			$euros = floor($precio_alquiler); // Obtiene la parte entera (euros)
			if (strlen($euros) == 4){
				$euros = substr($euros , 0, 1).".".substr($euros , -3);
			}
			$centimos = substr($precio_alquiler , -2); // Obtiene los céntimos
				
				
		?>

		
		<div align="right" class="div_dias_precio">
			<div class="titulo" style="vertical-align: middle">DÍAS:</div>
			<div class="valor"><?= e($contrato->dias) ?></div>
		</div>
	
		<div align="right" style="vertical-align: top">
			<div class="display_inline" style="vertical-align: middle">PRECIO ALQUILER:</div>
			<div class="precio_2 display_inline" style="background: <?= $verde ?>"><?= $euros ?>,<span class="centimos"><?= $centimos ?></span> €</div>
		</div>
